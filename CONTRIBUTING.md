...
1. [Fork](https://github.com/qualcomm/qemu-profiler/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/qemu-profiler.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/qemu-profiler.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/qemu-profiler/pulls) from your branch to `main`.
...
- Follow the existing style: run `cargo fmt` and `cargo clippy --all-targets` before submitting.
- Write tests.
